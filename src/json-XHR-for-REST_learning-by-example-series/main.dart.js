...
Isolate.$defineClass("LinkedHashMapImplementation", "Object", ["_map", "_lib2_list"], {
 ...
 forEach$1: function(f) {
  var t0 = ({});
  t0.f_1 = f;
  $.forEach(this._lib2_list, new $.Closure11(t0));
 },
 remove$1: function(key) {
...
Isolate.$defineClass("JsonpCallback", "Object", ["onDataReceived", "_onMessage?", "_script", "_callbackFunctionName?"], {
 ...
 doCallback$2: function(url, onData) {
  ...
  this._onMessage = new $.Closure2(this);
 ...
 JsonpCallback$1: function(_callbackFunctionName) {
...
Isolate.$defineClass("Closure", "Closure14", [], {
 $call$1: function(data) {
  $.print(data);
 }
});

Isolate.$defineClass("Closure2", "Closure14", ["this_0"], {
...
Isolate.$defineClass("Closure5", "Closure14", ["box_0", "output_2"], {
...
Isolate.$defineClass("Closure7", "Closure14", ["box_0"], {
 $call$0: function() {
...
Isolate.$defineClass("Closure11", "Closure14", ["box_0"], {
...
$.JsonpCallback$1 = function(_callbackFunctionName) {
  var t0 = new $.JsonpCallback((void 0), (void 0), (void 0), _callbackFunctionName);
  t0.JsonpCallback$1(_callbackFunctionName);
  return t0;
};
...
$.showTweets = function() {
  var twitterCallback = $.JsonpCallback$1('callbackMethod');
  twitterCallback.onDataReceived = new $.Closure();
  var twitterUrl = 'http://search.twitter.com/search.json?q=dartlang&callback=' + $.stringToString('callbackMethod');
  $.print(twitterUrl);
  twitterCallback.doCallback$1(twitterUrl);
};
